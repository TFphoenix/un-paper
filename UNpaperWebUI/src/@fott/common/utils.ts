...
export function filterFormat(type: FieldType | string): any[] {
  switch (type) {
    case FieldType.String:
      return [FieldFormat.NotSpecified, FieldFormat.Alphanumeric, FieldFormat.NoWhiteSpaces];
    case FieldType.Number:
      return [FieldFormat.NotSpecified, FieldFormat.Currency];
    case FieldType.Date:
      return [FieldFormat.NotSpecified, FieldFormat.DMY, FieldFormat.MDY, FieldFormat.YMD];
