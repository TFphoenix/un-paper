...
import { Customizer, Dialog, DialogFooter, DialogType, ICustomizations, ITheme, PrimaryButton } from '@fluentui/react';
import { getDarkTheme, getPrimaryBlueTheme } from 'src/@fott/common/themes';
...
export default class Alert extends React.Component<IAlertProps, IAlertState> {
        ...
        {this.props.show && (
          <Dialog
            ...
            dialogContentProps={{
              ...
              subText: this.getMessage(this.props.message) as string,
              isMultiline: true
            }}
            modalProps={{
              isBlocking: false
          ...
          >
            <DialogFooter>
              <PrimaryButton theme={getPrimaryBlueTheme()} onClick={this.onCloseClick} text={this.props.closeButtonText || 'OK'} />
            </DialogFooter>
          </Dialog>
        )}
      </Customizer>
  ...
  private onCloseClick() {
    if (this.props.onClose) {
      this.props.onClose.apply(null, this.state.params as []);
    }
  }
