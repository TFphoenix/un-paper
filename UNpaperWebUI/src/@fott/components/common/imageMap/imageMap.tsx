...
export class ImageMap extends React.Component<IImageMapProps> {
  ...
  public render() {
    return (
      <div onMouseLeave={this.handlePonterLeaveImageMap} onMouseEnter={this.handlePointerEnterImageMap} className="map-wrapper">
  ...
  public addInteraction = (interaction: Interaction) => {
    if (
      undefined ===
      this.map.getInteractions().array_.find(existingInteraction => {
  ...
  private createMapView = (projection: Projection, imageExtend: number[]) => {
    ...
    const rotation = this.props.imageAngle ? Utils.degreeToRadians((this.props.imageAngle + 360) % 360) : 0;
        ...
        if (features.length > 0) {
          ...
          if (feature && this.props.hoveringFeature !== feature.get('id')) {
            ...
            if (coordinates && coordinates.length > 0) {
              ...
              this.props.handleTableToolTipChange(
                'block',
                width + 2,
                height + 2,
                top + 43,
