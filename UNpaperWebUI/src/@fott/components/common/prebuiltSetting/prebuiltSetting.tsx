...
import { getGreenWithWhiteBackgroundTheme, getPrimaryGreyTheme } from 'src/@fott/common/themes';
import { IPrebuiltSettings } from 'src/@fott/models/applicationState';
import IAppPrebuiltSettingsActions from 'src/@fott/redux/actions/prebuiltSettingsActions';
    ...
    return (
      <>
        <div className="p-3 prebuilt-setting" style={{ marginTop: '-2rem' }}>
          ...
          <TooltipHost content={strings.prebuiltSetting.endpointTooltip}>
            <TextField
              className="mb-1"
              name="endpointUrl"
          ...
          <div className="apikeyContainer">
            <TooltipHost content={strings.prebuiltSetting.apiKeyTooltip}>
              <TextField
                className="apikey"
                name="apikey"
