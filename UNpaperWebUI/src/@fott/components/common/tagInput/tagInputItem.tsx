...
export default class TagInputItem extends React.Component<ITagInputItemProps, ITagInputItemState> {
  ...
  public render() {
    ...
    return (
      <div className={'tag-item-block'}>
        <div className={'tag-color'} style={style} onClick={this.onColorClick}></div>
        <div className={'tag-item-block-2'}>
          {this.props.tag && (
            <div ref={this.itemRef} className={this.getItemClassName()} style={style}>
              <div
  ...
  private getTagContent = () => {
    ...
    return (
      ...
      >
        {this.isTypeOrFormatSpecified() && <FontIcon iconName="Link" className="pl-1" />}
          ...
          <div className="tag-item-label-container">
            {(confidence || revised) && (
              <div className="tag-item-label-container-item1">
                {!revised && confidence && <div className="tag-item-confidence">{confidence}</div>}
                {revised && <FontIcon iconName="StatusCircleCheckmark" className="ms-Icon-25px" />}
              </div>
            )}
  ...
  private isTypeOrFormatSpecified = () => {
    ...
    return (
      (tag.type && tag.type !== FieldType.String) ||
