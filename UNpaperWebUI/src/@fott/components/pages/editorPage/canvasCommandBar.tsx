...
import { IProject, IAssetMetadata, AssetLabelingState } from 'src/@fott/models/applicationState';
...
export const CanvasCommandBar: React.FunctionComponent<ICanvasCommandBarProps> = (
  props: ICanvasCommandBarProps
) => {
  ...
  if (!disableAutoLabeling) {
    ...
    if (
      ...
      labelingState === AssetLabelingState.Trained
    ) {
  ...
  if (props.showLayerMenu) {
    const layerItem: ICommandBarItemProps = {
      ...
      subMenuProps: {
        items: [
          ...
          {
            key: 'selectionMark',
            text: strings.editorPage.canvas.canvasCommandBar.items.layers.subMenuItems
              .selectionMarks,
            canCheck: true,
    ...
    if (!props.enableDrawRegion) {
      layerItem.subMenuProps.items = layerItem.subMenuProps.items.filter(
        item => item.key !== 'DrawnRegions'
      );
      ...
      subMenuProps: {
        items: [
          ...
          },
          {
            ...
            text: strings.editorPage.canvas.canvasCommandBar.farItems.additionalActions
              .subIMenuItems.runOcrOnCurrentDocument,
            iconProps: { iconName: 'TextDocument' },
            onClick: () => {
              if (props.handleRunOcr) props.handleRunOcr();
            }
          },
          {
            key: 'runOcrForAllDocuments',
            text: strings.editorPage.canvas.canvasCommandBar.farItems.additionalActions
              .subIMenuItems.runOcrOnAllDocuments,
            iconProps: { iconName: 'Documentation' },
            onClick: () => {
              if (props.handleRunOcrForAllDocuments) props.handleRunOcrForAllDocuments();
            }
          },
          {
            key: 'runAutoLabelingCurrentDocument',
            text: strings.editorPage.canvas.canvasCommandBar.farItems.additionalActions
              .subIMenuItems.runAutoLabelingCurrentDocument,
            iconProps: { iconName: 'Tag' },
            disabled: disableAutoLabelingCurrentAsset,
            title: props.project?.predictModelId
              ? ''
              : strings.editorPage.canvas.canvasCommandBar.farItems.additionalActions.subIMenuItems
          ...
          },
          {
            ...
            text: strings.editorPage.canvas.canvasCommandBar.farItems.additionalActions
              .subIMenuItems.runAutoLabelingOnMultipleUnlabeledDocuments,
            iconProps: { iconName: 'Tag' },
            ...
            title: props.project?.predictModelId
              ...
              : strings.editorPage.canvas.canvasCommandBar.farItems.additionalActions.subIMenuItems
                  .noPredictModelOnProject,
            onClick: () => {
              if (props.handleRunAutoLabelingOnMultipleUnlabeledDocuments)
                props.handleRunAutoLabelingOnMultipleUnlabeledDocuments();
            },
            secondaryText:
              strings.editorPage.canvas.canvasCommandBar.farItems.additionalActions.subIMenuItems
                .costWarningMessage,
          ...
          },
          {
            ...
            onClick: () => {
              if (props.handleAssetDeleted) props.handleAssetDeleted();
            }
          }
        ]
      }
