...
import { IAsset, AssetState, ISize, AssetLabelingState } from 'src/@fott/models/applicationState';
  ...
  private renderBadges = (asset: IAsset): JSX.Element => {
    ...
    switch (asset.state) {
      case AssetState.Tagged:
        return (
          <span
            title={_.capitalize(_.lowerCase(AssetLabelingState[asset.labelingState]))}
