...
import { ILoadFileHelper, ILoadFileResult, LoadFileHelper } from 'src/@fott/common/LoadFileHelper';
// import { getAppInsights } from "../../../../services/telemetryService";
import { URIUtils } from 'src/@fott/common/utils';
...
import PredictResult, { ITableResultItem } from '../../common/predictResult/predictResult';
...
> {
  ...
  public render() {
    ...
    const onPrebuiltsPath: boolean = true;
  ...
  private handleClick = () => {
    ...
    this.getPrediction().then(this.handlePredictionResult).catch(this.handlePredictionError);
    // if (this.appInsights) {
  ...
  private async getPrediction(): Promise<any> {
    ...
    // REMEMBER: Make the second REST API call and get the response.
    return poll(
  ...
  private onTablePredictionClick = (predictedItem: ITableResultItem, tagColor: string) => {
    const makeTable = clickedFieldName => {
      function Cell(this: any, rowIndex, columnIndex, text = null, confidence = null) {
