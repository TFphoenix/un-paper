...
export default class TrainPanel extends React.Component<ITrainPanelProps, ITrainPanelState> {
  public render() {
    const currTrainRecord = this.props.currTrainRecord;

    return (
      <div className="m-3">
        <h2 className="unp-primary"> Training record </h2>
        <PrimaryButton theme={getPrimaryGreyTheme()} className="mt-3 d-none">
