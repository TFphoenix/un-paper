...
export default class TrainTable extends React.Component<ITrainTableProps, ITrainTableState> {
  public render() {
    return (
      <div className="train-accuracy-table-container">
        ...
        {this.props.accuracies && (
          <table className="accuracy-table table-sm">
            <tbody>
              <tr>
                <th className="tag-name">Tag</th>
                <th className="text-right">Estimated Accuracy</th>
              </tr>
