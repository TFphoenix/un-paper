...
//  */
// export function ensureSecurityToken(
//   project: IProject
// ): (
//   dispatch: Dispatch,
...
//     const tokenCountWithTheSamePrefix = appState.appSettings.securityTokens.filter(
//       (st) => st.name.startsWith(tokenPrefix)
//     ).length;

//     const tokenSuffix =
//       tokenCountWithTheSamePrefix === 0
//         ? ``
//         : ` [${tokenCountWithTheSamePrefix}]`;
//     securityToken = {
